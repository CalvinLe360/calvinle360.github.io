...
export const timelineData: TimelineContent[] = [
    {
        iconPath: "/companies/acaciaSystems.jpg",
    ...
    {
        iconPath: "/companies/doubleEdgeStudios.png",
    ...
    {
        iconPath: "/companies/arcadiaRedux.png",
    ...
    {
        iconPath: "/companies/universityOfAdelaide.png",
